...
echo -e "\e[1;91m ██─███─█▄▀─██▄▄▄▄─█\e[1;92m█─▄███─██─██─██▀██─██▀█"
echo -e "\e[1;91m ▀▄▄▄▀▄▄▄▀▀▄▄▀▄▄▄▄▄▀\e[1;92m▄▄▄▀▀▀▄▄▄▄▀▄▄▄▄▄▀▄▄▄▄▄▀"
echo -e "\e[1;91m ーーーーーーーーーー\e[1;92mーーーーーーーーーーー"
echo -e "\e[1;91m ℂ𝕠𝕕𝕖𝕕 𝔹𝕪 \e[1;92m𝔸𝕕𝕒𝕞 ℕ𝕠𝕧𝕚𝕔𝕖"
echo -e "\e[1;91m 𝕄𝕪 𝕊𝕦𝕡𝕡𝕠𝕣𝕥𝕖𝕕 \e[1;92m𝕄𝕦𝕫𝕫𝕒𝕜𝕚"
echo -e "\e[1;91m 𝕋𝕙𝕒𝕟𝕜𝕤 𝕋𝕠 𝕋𝕖𝕒𝕞 \e[1;92m𝕄𝕌𝕊𝕃𝕀𝕄 ℂ𝕐𝔹𝔼ℝ 𝔽𝔸ℂ𝔼"
echo -e "\e[1;91m ーーーーーーーー\e[1;92mーーーーーーーーー"

echo -e "\e[1;91m───▄▀▀▀▄▄▄▄▄▄▄▀▀▀▄───"
echo -e "\e[1;91m───█▒▒░░░░░░░░░▒▒█───"
echo -e "\e[1;91m────█░░\e[1;92m█\e[1;91m░░░░░\e[1;92m█\e[1;91m░░█────"
